...
If you're using an older version of spigot/paper, you might need to do the following changes to your **pom.xml** file, by adding this code to the "\<dependecies> \</dependencies>" section:
