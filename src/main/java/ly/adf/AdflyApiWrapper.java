...
public class AdflyApiWrapper {
	...
	private ly.adf.AdflySimpleRestClient rest;
	
	public AdflyApiWrapper() {
		rest = new ly.adf.AdflySimpleRestClient(BASE_SCHEME, BASE_HOST);
	}
	...
	private String computeHash(Map<String, Object> params) {
		...
		String query = ly.adf.AdflySimpleRestClient.buildQuery(sortedParams);
